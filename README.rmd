...
> Note: RRASSLER creates data as part of it's processing.  Although every effort has been made to ensure that the form of that data is not so inflexible that future bug-fixes and enhancements break the resulting structure, we can make no guarentee that changes made, particularly to parsing process and accuracy, edge case handling, and accounting, would not require "reprocessing" records, something that is best accomplished using the original data.  As noted above, this package and several of it's cohort are still actively being developed.  Although the core logic of record creation has been stabilized for the time being, the "final" form of these tables is still in flux. 
