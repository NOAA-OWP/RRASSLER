...
![](https://raw.githubusercontent.com/NOAA-OWP/RRASSLER/main/man/figures/RRASSLER_algo.drawio.png)

Let's take a look at a few "real life" examples of these outputs and how we should interpret them.

![](https://raw.githubusercontent.com/NOAA-OWP/RRASSLER/main/man/figures/RRASSLER_names.png)
...
| Attribute       | Description                                                                                                                                                                                                                                                                                    | relevant layers |
|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| xid             | A model specific transect id                                                                                                                                                                                                                                                                   | transects       |
| master_id       | A catalog specific, globally unique transect id                                                                                                                                                                                                                                                | transects       |
...
Slightly more tangibly, when RRASSLER has been run all the way through, you'll have access to the index files which look like so (in R):
...
dat = gpd("../inst/extdata/sample_output/ras_catalog/model_footprints.fgb")
head(dat)
```
