...
remotes::install_github("NOAA-OWP/RRASSLER@dev_merge")
RRASSLER::marco()

message(paste("Running in:",fs::path_package("", package = "RRASSLER")))

ras_dbase <- "C:/Users/rdp-user/Desktop/testing"

RRASSLER::ingest_into_database(path_to_ras_dbase = ras_dbase,
                               top_of_dir_to_scrape = file.path(fs::path_package("", package = "RRASSLER"),"extdata/sample_ras/FEMA-R6-BLE-sample-dataset/",fsep = .Platform$file.sep),
...
RRASSLER::append_catalog_fields(path_to_ras_dbase = ras_dbase,
                                out_name = "OWP_ras_model_catalog.csv",
                                overwrite = FALSE,
                                is_verbose = TRUE)
```
...
```{r, eval=FALSE}
xyz = arrow::read_parquet("~/data/ras_catalog/models/5791934_COLORADO RIVER_g01_1700261677/RRASSLER_cs_pts.parquet")
utils::head(xyz,5)
ls = sfheaders::sf_linestring(
  obj = xyz
  , x = "x"
...
sf::st_write(ls,"~/data/temp/tras_xyz_lines.fgb")
```
...
## RAS2FIM off AOI helper

```{r, eval = FALSE}
# Using https://www.google.com/maps/@30.1029252,-97.2764193,11.89z?entry=ttu
lat = -97.2764193
lon = 30.1029252
zoom = 11.9
