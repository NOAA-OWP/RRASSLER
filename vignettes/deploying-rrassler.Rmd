...
```{r, eval = FALSE}
message(paste("Running in:",fs::path_package("", package = "RRASSLER")))
ras_dbase <- fs::path_package("./inst/extdata/sample_output/ras_catalog/", package = "RRASSLER")
# or: ras_dbase <- file.path(fs::path_package("", package = "RRASSLER"),)
fs::path_package("extdata/sample_output/ras_catalog/", package = "RRASSLER")
```

## B) As a developer using the docker setup
```{r, eval = FALSE}
