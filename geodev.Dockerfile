...
RUN R -q -e 'install.packages("gmailr")'
RUN R -q -e 'install.packages("alphahull")'
RUN R -q -e 'install.packages("igraph")'
RUN R -q -e 'remotes::install_github("jimcoll/holyhull")'
